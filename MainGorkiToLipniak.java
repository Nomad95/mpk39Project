...
public class MainGorkiToLipniak extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_gorki_to_lipniak);
    ...
    public InputStream otworzPlik()
    {
        ...
        try {
            otworzAsset = getResources().getAssets().open("gorkitolipniak.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
