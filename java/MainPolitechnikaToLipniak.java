...
public class MainPolitechnikaToLipniak extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main_politechnika_to_lipniak);
    ...
    public InputStream otworzPlik()
    {
        ...
        try {
            otworzAsset = getResources().getAssets().open("politechnikatolipniak.csv");
        } catch (IOException e) {
            e.printStackTrace();
        }
